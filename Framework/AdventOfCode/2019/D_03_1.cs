...
namespace AdventOfCode._2019
{
    public static class D_03_1
    {
        public static void Execute()
        {
            ...
            {
                if (path2.Any(x => x.X == path1Coord.X && x.Y == path1Coord.Y && path1Coord.X != 0 && path1Coord.Y != 0))
                {
                    intersections.Add(Math.Abs(path1Coord.X) + Math.Abs(path1Coord.Y));
                }
            }

            Console.WriteLine(intersections.Min());
        }
