...
namespace AdventOfCode._2016
{
    public static class D_10_1
    {
        ...
        private static void PerformSwap(string firstAction, int firstReceivingBotId, string firstBotOrOutput, int secondReceivingBotId, string secondBotOrOutput, int secondBot, int botId, ref List<Bot> bots)
        {
            ...
            if ((firstReceivingBot.Chip1 == 61 && firstReceivingBot.Chip2 == 17) || (firstReceivingBot.Chip1 == 17 && firstReceivingBot.Chip2 == 61)
                    || (secondReceivingBot.Chip1 == 61 && secondReceivingBot.Chip2 == 17) || (secondReceivingBot.Chip1 == 17 && secondReceivingBot.Chip2 == 61))
            {
                Console.WriteLine($"Bot {firstReceivingBot.Id} is comparing 61 and 17");
            }
        }
