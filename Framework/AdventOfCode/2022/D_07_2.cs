...
namespace AdventOfCode._2022
{
    public class D_07_2
    {
        ...
        { 
            ...
            long usedSpace = directories.Single(d => d.Id == 0).Size;
            long requiredSpace = 30000000;
            long unusedSpace = totalSpace - usedSpace;
            long spaceToFreeUp = requiredSpace - unusedSpace;

            Console.WriteLine(directories.Where(d => d.Size >= spaceToFreeUp).OrderBy(d => d.Size).First().Size);
        }
    }
}
