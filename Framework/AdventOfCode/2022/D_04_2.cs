    ...
    public class D_04_2
    {
        ...
        { 
            ...
            foreach (string elfPair in elfPairs)
            {
                ...
                if (elf1Boundaries[0] >= elf2Boundaries[0] && elf1Boundaries[0] <= elf2Boundaries[1])
                {
                    overlappingPairs += 1;
                    continue;
                }

                if (elf1Boundaries[1] >= elf2Boundaries[0] && elf1Boundaries[1] <= elf2Boundaries[1])
                {
                    overlappingPairs += 1;
                    continue;
                }

                if (elf2Boundaries[0] >= elf1Boundaries[0] && elf2Boundaries[0] <= elf1Boundaries[1])
                {
                    overlappingPairs += 1;
                    continue;
                }

                if (elf2Boundaries[1] >= elf1Boundaries[0] && elf2Boundaries[1] <= elf1Boundaries[1])
                {
                    overlappingPairs += 1;
                    continue;
                }
